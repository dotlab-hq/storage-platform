/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f59ac64f2cbd014e6b07248495edb851)
// Runtime types generated with workerd@1.20260421.1 2026-03-24 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "TrashDeletionStateDO";
	}
	interface Env {
		KV: KVNamespace;
		DB_D1: D1Database;
		...
		ASSETS: Fetcher;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_DB: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
		_GITHUB_CLIENT_ID: string;
		_GITHUB_CLIENT_SECRET: string;
		STORAGE_PROVIDER_ENCRYPTION_KEY: string;
		...
		"21ST_DEV_API_KEY": string;
		S3_TEST_ENDPOINT: string;
		S3_TEST_REGION: string;
		S3_TEST_BUCKET: string;
		S3_TEST_ACCESS_KEY_ID: string;
		S3_TEST_SECRET_ACCESS_KEY: string;
		S3_TEST_DUMMY_FILE_PATH: string;
		S3_TEST_SD_COMPARTMENT_PREFIX: string;
		S3_TEST_ENABLE_MULTIPART: string;
		TRASH_DELETION_STATE: DurableObjectNamespace<import("./src/server").TrashDeletionStateDO>;
		TRASH_DELETION_WORKFLOW: Workflow<Parameters<import("./src/server").TrashDeletionWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_DB" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "_GITHUB_CLIENT_ID" | "_GITHUB_CLIENT_SECRET" | "STORAGE_PROVIDER_ENCRYPTION_KEY" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "LANGSMITH_API_KEY" | "LANGSMITH_TRACING" | "LANGSMITH_ENDPOINT" | "LANGSMITH_PROJECT" | "GOOGLE_API_KEY" | "21ST_DEV_API_KEY" | "S3_TEST_ENDPOINT" | "S3_TEST_REGION" | "S3_TEST_BUCKET" | "S3_TEST_ACCESS_KEY_ID" | "S3_TEST_SECRET_ACCESS_KEY" | "S3_TEST_DUMMY_FILE_PATH" | "S3_TEST_SD_COMPARTMENT_PREFIX" | "S3_TEST_ENABLE_MULTIPART">> {}
}
