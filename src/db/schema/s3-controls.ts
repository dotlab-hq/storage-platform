...
export const bucketCorsRule = schema.table(
  ...
  (table) => [
    uniqueIndex('bucketCorsRule_bucket_order_unq').on(
      table.bucketId,
      table.ruleOrder,
    ),
...
export const fileVersion = schema.table(
  'file_version',
  {
    ...
    isDeleteMarker: integer('is_delete_marker', { mode: 'boolean' })
      .default(false)
      .notNull(),
    etag: text('etag'),
  ...
  (table) => [
    uniqueIndex('fileVersion_bucket_key_version_unq').on(
      table.bucketId,
      table.objectKey,
      table.versionId,
    ),
    index('fileVersion_bucket_key_created_idx').on(
      table.bucketId,
      table.objectKey,
      table.createdAt,
    ),
