...
export function validateCorsTestCases(): void {
    ...
    console.log( 'Test 1 - Default config:', test1.valid ? '✓ PASS' : '✗ FAIL', test1.errors )
    ...
    console.log( 'Test 2 - Missing origins:', !test2.valid ? '✓ PASS' : '✗ FAIL', test2.errors )
    ...
    console.log( 'Test 3 - Invalid method:', !test3.valid ? '✓ PASS' : '✗ FAIL', test3.errors )
    ...
    console.log( 'Test 4 - MaxAge too high:', !test4.valid ? '✓ PASS' : '✗ FAIL', test4.errors )
    ...
    console.log( 'Test 5 - Custom valid config:', test5.valid ? '✓ PASS' : '✗ FAIL', test5.errors )
