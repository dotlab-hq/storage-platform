  ...
  return (
    <>
      <Dialog open={bucketName !== null} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-lg border border-emerald-500/20 bg-card shadow-xl">
          ...
          {credentials && (
            <div className="space-y-3 text-xs">
              <div className="rounded-lg border border-emerald-500/20 bg-muted/20 p-3">
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="mt-1 break-all rounded-md border border-emerald-500/20 bg-background/60 px-2 py-1 font-mono text-xs">
                      ...
                      <TooltipTrigger asChild>
                        <span>
                          <Button
                            ...
                            className="gap-2 border-amber-500/50 text-amber-200 hover:bg-amber-500/15"
                          >
                            {isRotating ? (
