...
This suite validates S3 compatibility endpoints against the hosted gateway at `https://storage.wpsrde.dev` using Playwright + AWS SDK.
...
- `S3_TEST_ENDPOINT` (default: `https://storage.wpsrde.dev`)
