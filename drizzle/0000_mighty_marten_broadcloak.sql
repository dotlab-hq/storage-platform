...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `uploadAttempt_userId_idx` ON `upload_attempt` (`user_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `uploadAttempt_bucketId_idx` ON `upload_attempt` (`bucket_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `uploadAttempt_status_idx` ON `upload_attempt` (`status`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `uploadAttempt_providerId_idx` ON `upload_attempt` (`provider_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `virtualBucket_userId_idx` ON `virtual_bucket` (`user_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `virtualBucket_mappedFolderId_idx` ON `virtual_bucket` (`mapped_folder_id`);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `storage_provider` (
    ...
    `proxy_uploads_enabled` integer DEFAULT false NOT NULL,
    `is_active` integer DEFAULT true NOT NULL,
    `created_at` integer NOT NULL,
    `updated_at` integer NOT NULL
);
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `file_userId_idx` ON `file` (`user_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `file_providerId_idx` ON `file` (`provider_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `file_folderId_idx` ON `file` (`folder_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `folder_virtual_bucket_id_unique` ON `folder` (`virtual_bucket_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `folder_userId_idx` ON `folder` (`user_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `folder_parentFolderId_idx` ON `folder` (`parent_folder_id`);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `share_link` (
    ...
    CONSTRAINT "share_link_target_check" CHECK (
        (
            "file_id" IS NOT NULL
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `share_link_share_token_unique` ON `share_link` (`share_token`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `shareLink_fileId_idx` ON `share_link` (`file_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `shareLink_folderId_idx` ON `share_link` (`folder_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `shareLink_sharedByUserId_idx` ON `share_link` (`shared_by_user_id`);
--> statement-breakpoint
