...
INSERT INTO `__new_qr_login_offer`(
	"id",
	"code",
	"poll_key",
	"owner_user_id",
...
SELECT
	...
	"expires_at",
	"claimed_at"
FROM `qr_login_offer`;--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS `qr_login_offer_poll_key_unique` ON `qr_login_offer` (`poll_key`);--> statement-breakpoint
