...
CREATE INDEX `chatMessageAttachment_messageId_idx` ON `chat_message_attachment` (`message_id`);--> statement-breakpoint
CREATE INDEX `chatMessageAttachment_bucket_object_idx` ON `chat_message_attachment` (`bucket_name`,`object_key`);--> statement-breakpoint
...
CREATE INDEX `chatMessage_threadId_idx` ON `chat_message` (`thread_id`);--> statement-breakpoint
CREATE INDEX `chatMessage_userId_idx` ON `chat_message` (`user_id`);--> statement-breakpoint
CREATE INDEX `chatMessage_createdAt_idx` ON `chat_message` (`created_at`);--> statement-breakpoint
